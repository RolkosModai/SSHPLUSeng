                    ...
                    then
                      ...
                      then
                        ...
                        then
                          ...
                          if [[ -e /etc/openvpn/server.conf ]]; then
                              echo -ne "\033[1;32mYou Need OpenVPN config ? \033[1;33m[s/n]:\033[1;37m "; read resp
                              if [[ "$resp" = @(s|S) ]]; then
...
mine_port ; echo -e "====================" ; echo -e "\033[1;36mSupport:" ; echo -e "\033[1;95m➩ Online Games" ; echo -e "\033[1;91m➩ ʏᴏᴜᴛᴜʙᴇ ʜᴅ" ; echo -e "\033[1;92m➩ Whatsapp Video call " ; echo "" ; echo "" || echo "Unable to create user!" ; tput sgr0
                                sleep 1
                                function aguarde {
                                  helice () {
