...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	wget -c -P /home https://raw.githubusercontent.com/RolkosModai/SSHPLUSeng/master/versao
...
[[ "$vrs1" == "$vrs2" ]] && {
  echo -e " \033[1;36m     SCRIPT ALREADY UPDATED!\033[1;32m\n"
  rm /tmp/att > /dev/null 2>&1
  echo -e " \033[1;33m MORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@Asrolka"
  echo -ne " \033[1;31m ENTER \033[1;33mto return to \033[1;32mMENU!\033[0m"; read
  menu
} || {
  echo -e "  \033[1;36mTHERE IS A NEW UPDATE AVAILABLE!\033[1;33m\n"
  echo -e "  \033[1;33mMORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@Asrolka\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    sleep 3
    wget https://raw.githubusercontent.com/RolkosModai/SSHPLUSeng/master/sshplus.sh > /dev/null 2>&1
    chmod +x sshplus.sh
    ./sshplus.sh
    clear
