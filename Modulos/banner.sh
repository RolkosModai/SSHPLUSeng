...
echo ""
echo -ne "\033[1;32mType Number Option You Want\033[1;31m ?\033[1;37m : "; read resp
if [[ "$resp" = "1" ]]; then
echo ""
echo -ne "\033[1;32mWHAT MESSAGE WILL YOU DISPLAY\033[1;31m ?\033[1;37m : "; read msg1
if [[ -z "$msg1" ]]; then
	echo -e "\n\033[1;31mEmpty or invalid field !\033[0m"
	sleep 2
	banner
fi
echo -e "\n\033[1;31m[\033[1;36m01\033[1;31m]\033[1;33m SMALL Front"
echo -e "\033[1;31m[\033[1;36m02\033[1;31m]\033[1;33m MEDIUM Front"
echo -e "\033[1;31m[\033[1;36m03\033[1;31m]\033[1;33m BIG Front"
echo -e "\033[1;31m[\033[1;36m04\033[1;31m]\033[1;33m GIANT Front"
echo ""
echo -ne "\033[1;32mWHAT Front SIZE\033[1;31m ?\033[1;37m : "; read opc
...
echo ""
echo -ne "\033[1;32mWHAT'S THE COLOR\033[1;31m ?\033[1;37m : "; read ban_cor
...
echo -e "\n\033[1;32mDone Created BANNER !\033[0m"
sleep 2
menu
else
...
echo "</font></h$_size> <font color='cyan'>RolkosMod" >> $local
